...
let canWeDeliver = zipCodes.includes(deliveryAreaZipCodes)
if (deliveryAreaZipCodes.indexOf('') != -1) {
    alert("sorry, we cant deliver to that adress")

    } else {
        alert("You're in our deliver zone!")
    }
console.log(85205)
